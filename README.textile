...
The Genomic Peptide Finder is a tool that matches de novo predicted amino acid sequences to the genomic DNA sequence of an organisms. The matching procedure is error-tolerant to accomodate possible sequencing errors due to individual missing fragment ions. In addition, spliced peptides can be deduced.
...
# Specht M, Stanke M, Terashima M, Naumann-Busch B, Janßen I, Höhner R, Hom EFY, et al. 2011. "Concerted action of the new Genomic Peptide Finder and AUGUSTUS allows for automated proteogenomic annotation of the Chlamydomonas reinhardtii genome.":http://dx.goi.org/10.1002/pmic.201000621 Proteomics 11:1814-1823.
