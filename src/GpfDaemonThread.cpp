...
void k_GpfDaemonThread::run()
{
	...
	if (lk_RequestVars.contains("genome"))
	{
		...
		// TODO: change this crummy error handling, an illegal request should be treated as
		// an illegal request so that bad input is not being passed on to further processing
